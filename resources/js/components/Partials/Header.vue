<template>
    <nav
        class="nav navbar theme navbar-expand-xl bg-white iq-navbar navbar-scroll"
        aria-label="Main navigation"
    >
        <div class="container-fluid p-0">
            <div class="header-left d-flex align-itens-center">
                    ...
                    >
                        <li class="nav-item">
                            <router-link
                                ...
                                :class="
                                    currentRouteName === 'frontend-home'
                                        ? activeRouteClass + ' nav-link'
                                        : 'nav-link'
                                "
                        ...
                        <li class="nav-item">
                            <router-link
                                :to="{ name: 'service' }"
                                :class="
                                    currentRouteName === 'service' ||
                                    currentRouteName === 'service-detail' ||
                                    currentRouteName === 'category-service' ||
                                    currentRouteName === 'provider-service'
                                        ? activeRouteClass + ' nav-link'
                                        : 'nav-link'
                                "
                        ...
                        <li v-if="isLogged" class="nav-item">
                            <router-link
                                :to="{ name: 'booking' }"
                                :class="
                                    currentRouteName === 'booking' ||
                                    currentRouteName === 'booking-detail'
                                        ? activeRouteClass + ' nav-link'
                                        : 'nav-link'
                                "
            ...
            <div class="header-right d-flex align-itens-center">
                <div class="location-device-lg" v-b-modal.nearlocation>
                    <div class="header-address">
                        ...
                        <span class="ps-2">{{
                            __("messages.search_for_your_area")
                        }}</span>
                    </div>
                </div>
                <div class="location-device-sm position-relative">
                    <div
                        ...
                        @click="$bvModal.show('nearlocation')"
                    >
                        <span class="icon">
                            <svg
                                width="18"
                ...
                <div
                    class="input-group search-text search-device-lg"
                    style="width: auto"
                >
                    <input
                        type="text"
                        :placeholder="__('messages.search')"
                        class="form-control nav-item dropdown"
                        @keyup="getServiceList"
                        v-model="keyword"
                    ...
                    <ul
                        :class="`top-width dropdown-menu dropdown-menu-end user-dropdown ${
                    ...
                    >
                        <li>
                            <div
                                v-if="serviceList.length > 0 && !show"
                                class="searchbox-datalink global-search-result show-data"
                                :key="componentKey"
                            >
                                <ul class="iq-post p-3">
                                    <div>
                                        ...
                                        >
                                            ...
                                            >
                                                <div
                                                    class="post-img d-flex align-items-center"
                                                >
                                                    <div
                                                        class="post-img-holder"
                                                    >
                                                        <a href="img-height">
                                                            <img
                                                                :src="
                        ...
                        <li>
                            <div
                                v-if="show && serviceList.length == 0"
                                class="searchbox-datalink global-search-result show-data"
                            >
                                <ul class="iq-post">
                                    <div>
                ...
                <div class="d-flex align-items-center">
                    <div
                        class="search-text position-relative search-device-sm cursor-pointer"
                    >
                    ...
                    <div class="user">
                        <button class="user-menu" id="user-menu">
                            <i
                                aria-hidden="true"
                                alt="user"
                                class="far fa-user"
                ...
                <div
                    class="d-flex align-items-center header-buttons header-buttons-desktop"
                >
                    <button
                        ...
                        <li v-if="isLogged" class="nav-item dropdown">
                            ...
                            >
                                <li>
                                    <router-link
                                        class="dropdown-item"
                                        :to="{ name: 'user-favourite' }"
                                        ><i class="fas fa-star me-2 fa-sm"></i
                                        >{{
                                            __("messages.favorite_list")
                                        }}</router-link
                                    >
                                </li>
                                <li>
                                    <a
                                        ...
                                        @click="getHomePage()"
                                        ><i
                                            class="fas fa-chart-bar me-2 fa-sm"
                                        ></i
                                        >{{ __("messages.dashboard") }}</a
                                    >
                                </li>
                                <li>
                                    <a
                                        ...
                                        @click="logout"
                                        ><i
                                            class="fas fa-sign-out-alt me-2 fa-sm"
                                        ></i
                                        >{{ __("messages.logout") }}</a
                                    >
                                </li>
                ...
                <div class="row row-cols-2 pt-4">
                    <div class="col">
                        <button
                            ...
                            @click="$bvModal.hide('nearlocation')"
                        >
                            {{ __("messages.cancel") }}
                        </button>
                    </div>
...
export default {
    ...
    methods: {
        ...
        changeCurrency() {
            // Implement logic to update the currency and perform any necessary actions
            console.log("Selected Currency:", this.selectedCurrency);
            // You can also trigger API requests or other actions here
        },
        getServices() {
