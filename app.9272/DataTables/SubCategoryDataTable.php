    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('status' , function ($subcategory){
                ...
                return '<div class="custom-control custom-switch custom-switch-text custom-switch-color custom-control-inline">
                    <div class="custom-switch-inner">
                        <input type="checkbox" class="custom-control-input  change_status" data-type="subcategory_status" '.($subcategory->status ? "checked" : "").'  '.$disabled.' value="'.$subcategory->id.'" id="'.$subcategory->id.'" data-id="'.$subcategory->id.'">
            ...
            ->editColumn('is_featured' , function ($subcategory){
                ...
                return '<div class="custom-control custom-switch custom-switch-text custom-switch-color custom-control-inline">
                    <div class="custom-switch-inner">
                        <input type="checkbox" class="custom-control-input change_status" data-type="subcategory_featured" data-name="is_featured" '.($subcategory->is_featured ? "checked" : "").'  '.  $disabled.' value="'.$subcategory->id.'" id="f'.$subcategory->id.'" data-id="'.$subcategory->id.'">
