    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('is_verified' , function ($provider_document){
                ...
                return '<div class="custom-control custom-switch custom-switch-text custom-switch-color custom-control-inline">
                    <div class="custom-switch-inner">
                        <input type="checkbox" class="custom-control-input bg-primary change_status" data-type="provider_is_verified" data-name="provider_is_verified" '.($provider_document->is_verified ? "checked" : "").' '.$disabled.'  value="'.$provider_document->id.'" id="'.$provider_document->id.'" data-id="'.$provider_document->id.'">
            ...
            ->editColumn('provider_id' , function ($provider_document){
                return ($provider_document->provider_id != null && isset($provider_document->providers)) ? '<a class="btn-link btn-link-hover" href='.route('providerdocument.create', ['id' => $provider_document->id]).'>'.$provider_document->providers->display_name.'</a>' : '';
            })
